...
const Create: NextPage = (props) => {
  ...
  const handleClick = async () => {
    setActivating(true);
    try {
      const response = await fetch('http://localhost:1323/mnfts', {
        method: 'POST',
        headers: {
  ...
  const handleLocationChange = (event) => {
    ...
    if (selectedLocation) {
      Weather.locationId = selectedLocation.locationID;
  ...
  return (
    <div>
      <CreatePageWrapper>
        <CreateView>
          <Title>Create New Time DNFT</Title>
          <Box>
            <FieldTitle>Set time interval</FieldTitle>
            <Helper className='mb-4'>
              Set how many time intervals the NFT will change.
            </Helper>
            ...
            <FieldTitle>Image setting by Time</FieldTitle>
            <Helper>
            ...
            <TextField
              multiline
              fullWidth
              label='First Time DNFT-description'
              rows={2}
              margin='dense'
              id='description'
            ...
            <TextField
              multiline
              fullWidth
              label='Second Time DNFT-description'
              rows={2}
              margin='dense'
              id='description'
            ...
            <TextField
              multiline
              fullWidth
              label='Third Time DNFT-description'
              rows={2}
              margin='dense'
              id='description'
            ...
            <TextField
              multiline
              fullWidth
              label='Fourth Time DNFT-description'
              rows={2}
              margin='dense'
              id='description'
            ...
            <FlipCard>
              <FrontCard isCardFlipped={message}>
                ...
                <div style={{ padding: 24 }}>
                  ...
                  <h1 style={{ marginTop: 24 }}>Time Interval: {location}</h1>{' '}
