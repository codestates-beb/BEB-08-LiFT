...
class CacheHandler {
    ...
    constructor(_ctx){}
    async get(_key, _fetchCache, _originUrl, _fetchIdx) {
        return {};
    }
    async set(_key, _data, _fetchCache, _originUrl, _fetchIdx) {}
}
...
class IncrementalCache {
    ...
    async get(pathname, fetchCache, revalidate, originUrl, fetchIdx) {
        var ref, ref1, ref2;
        ...
        let entry = null;
        const cacheData = await ((ref = this.cacheHandler) == null ? void 0 : ref.get(pathname, fetchCache, originUrl, fetchIdx));
        ...
        if (!cacheData && this.prerenderManifest.notFoundRoutes.includes(pathname)) {
            ...
            this.set(pathname, entry.value, curRevalidate, fetchCache, originUrl, fetchIdx);
        }
        return entry;
    }
    // populate the incremental cache with new data
    async set(pathname, data, revalidateSeconds, fetchCache, originUrl, fetchIdx) {
        ...
        try {
            ...
            await ((ref = this.cacheHandler) == null ? void 0 : ref.set(pathname, data, fetchCache, originUrl, fetchIdx));
        } catch (error) {
