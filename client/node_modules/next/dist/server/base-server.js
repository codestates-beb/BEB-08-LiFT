...
var _responseHandlers = require("./future/route-modules/helpers/response-handlers");
var _utils3 = require("./web/utils");
...
class Server {
        ...
        try {
            ...
            if (this.minimalMode && typeof req.headers["x-matched-path"] === "string") {
                try {
                    ...
                    const localeAnalysisResult = (ref4 = this.i18nProvider) == null ? void 0 : ref4.analyze(matchedPath, {
                        defaultLocale
                    });
                    ...
                    for (const key1 of routeParamKeys){
                        delete parsedUrl.query[key1];
                    }
   ...
   */ async prepare() {
    ...
    async renderToResponseWithComponentsImpl({ req , res , pathname , renderOpts: opts  }, { components , query  }) {
        ...
        const hasGetInitialProps = !!((ref9 = components.Component) == null ? void 0 : ref9.getInitialProps);
        ...
        if (opts.supportsDynamicHTML === true) {
            ...
            const isSupportedDocument = typeof ((ref8 = components.Document) == null ? void 0 : ref8.getInitialProps) !== "function" || // The built-in `Document` component also supports dynamic HTML for concurrent mode.
        ...
        const defaultLocale = isSSG ? (ref6 = this.nextConfig.i18n) == null ? void 0 : ref6.defaultLocale : query.__nextDefaultLocale;
        const locale = query.__nextLocale;
        const locales = (ref7 = this.nextConfig.i18n) == null ? void 0 : ref7.locales;
        let previewData;
                ...
                try {
                    ...
                    if (response) {
                        ...
                        if (isSSG && process.env.NEXT_RUNTIME !== "edge") {
                            ...
                            let revalidate = (ref = context.staticGenerationContext.store) == null ? void 0 : ref.revalidate;
        ...
        if (isSSG && !this.minimalMode) {
            ...
            res.setHeader("x-nextjs-cache", isOnDemandRevalidate ? "REVALIDATED" : cacheEntry1.isMiss ? "MISS" : cacheEntry1.isStale ? "STALE" : "HIT");
        }
        ...
        if (!cachedData) {
            ...
            await (0, _sendResponse).sendResponse(req, res, new Response(cachedData.body, {
                headers: (0, _utils3).fromNodeHeaders(cachedData.headers),
