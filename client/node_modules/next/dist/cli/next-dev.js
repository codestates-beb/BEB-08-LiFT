        ...
        const runDevServer = async ()=>{
            ...
            try {
                ...
                const setupFork = async (newDir)=>{
                    ...
                    if (((ref3 = config.experimental) == null ? void 0 : ref3.appDir) && !devServerOptions.useWorkers) {
                        Log.error(`Disabling dev workers is not supported with appDir enabled`);
                    }
                };
                cleanupFns.push(()=>{
                ...
                projectFolderWatcher.on("aggregated", async ()=>{
                    ...
                    try {
                        ...
                        if ((ref4 = err.message) == null ? void 0 : ref4.includes("experimental")) {
                            return;
                        }
                    }
                    ...
                    try {
                        var ref5;
                        const result = (0, _findPagesDir).findPagesDir(newFiles[0], !!(config == null ? void 0 : (ref5 = config.experimental) == null ? void 0 : ref5.appDir));
                        hasPagesApp = Boolean(result.pagesDir || result.appDir);
                    } catch (_) {}
