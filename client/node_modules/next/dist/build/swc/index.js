...
exports.teardownCrashReporter = exports.teardownTraceSubscriber = exports.teardownHeapProfiler = exports.initHeapProfiler = exports.initCustomTraceSubscriber = exports.lockfilePatchPromise = exports.__isCustomTurbopackBinary = void 0;
...
var ref;
const nextVersion = "13.3.1-canary.6";
const ArchName = (0, _os).arch();
const PlatformName = (0, _os).platform();
const triples = ((ref = _triples.platformArchTriples[PlatformName]) == null ? void 0 : ref[ArchName]) || [];
const infoLog = (...args)=>{
      ...
      if (telemetry.isEnabled) {
        ...
        nativeBindings = {
            ...
            transform (src, options) {
                ...
                options = options || {};
                if (options == null ? void 0 : (ref1 = options.jsc) == null ? void 0 : ref1.parser) {
            ...
            transformSync (src, options) {
                ...
                options = options || {};
                if (options == null ? void 0 : (ref2 = options.jsc) == null ? void 0 : ref2.parser) {
                    options.jsc.parser.syntax = options.jsc.parser.syntax ?? "ecmascript";
                }
...
exports.initHeapProfiler = initHeapProfiler;
...
exports.teardownHeapProfiler = teardownHeapProfiler;
