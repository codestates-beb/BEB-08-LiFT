...
function getRSCModuleInformation(source, isServerLayer = true) {
    ...
    const clientRefs = clientInfoMatch == null ? void 0 : (ref2 = clientInfoMatch[1]) == null ? void 0 : ref2.split(",");
    ...
    if (Array.isArray(swcAST == null ? void 0 : swcAST.body)) {
        try {
            ...
            for (const node of swcAST.body){
                ...
                if (node.type === "ExportDeclaration" && ((ref10 = node.declaration) == null ? void 0 : ref10.type) === "VariableDeclaration") {
                    var ref6;
                    for (const declaration of (ref6 = node.declaration) == null ? void 0 : ref6.declarations){
                ...
                if (node.type === "ExportDeclaration" && ((ref3 = node.declaration) == null ? void 0 : ref3.type) === "FunctionDeclaration" && [
                    "getStaticProps",
                    "getServerSideProps"
                ].includes((ref4 = node.declaration.identifier) == null ? void 0 : ref4.value)) {
                    ssg = node.declaration.identifier.value === "getStaticProps";
                    ssr = node.declaration.identifier.value === "getServerSideProps";
                }
                if (node.type === "ExportDeclaration" && ((ref5 = node.declaration) == null ? void 0 : ref5.type) === "VariableDeclaration") {
                    var ref7, ref8;
                    const id = (ref8 = (ref7 = node.declaration) == null ? void 0 : ref7.declarations[0]) == null ? void 0 : ref8.id.value;
                    if ([
                        "getStaticProps",
                        "getServerSideProps"
                    ].includes(id)) {
                ...
                if (node.type === "ExportNamedDeclaration") {
                    const values = node.specifiers.map((specifier)=>{
                        var ref, ref9;
                        return specifier.type === "ExportSpecifier" && ((ref = specifier.orig) == null ? void 0 : ref.type) === "Identifier" && ((ref9 = specifier.orig) == null ? void 0 : ref9.value);
                    });
...
async function getPageStaticInfo(params) {
    ...
    if (/runtime|getStaticProps|getServerSideProps|export const config/.test(fileContent)) {
        ...
        resolvedRuntime = (0, _isEdgeRuntime).isEdgeRuntime(resolvedRuntime) ? resolvedRuntime : requiresServerRuntime ? resolvedRuntime || ((ref14 = nextConfig.experimental) == null ? void 0 : ref14.runtime) : undefined;
