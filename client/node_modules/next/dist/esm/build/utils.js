...
export async function isPageStatic({ page , distDir , configFileName , runtimeEnvConfig , httpAgentOptions , enableUndici , locales , defaultLocale , parentId , pageRuntime , edgeInfo , pageType , hasServerComponents , originalAppPath , isrFlushToDisk , maxMemoryCacheSize , incrementalCacheHandlerPath  }) {
    ...
    return isPageStaticSpan.traceAsyncFn(async ()=>{
        ...
        if (pageType === "app") {
            ...
            const userland = (ref = componentsResult.ComponentMod.routeModule) == null ? void 0 : ref.userland;
