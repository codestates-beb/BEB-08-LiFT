...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, turboNextBuild = false) {
    ...
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (isAppDirEnabled) {
                process.env.NEXT_PREBUNDLED_REACT = useExperimentalReact ? "experimental" : "next";
            }
            ...
            const hasPages404 = (ref3 = mappedPages["/404"]) == null ? void 0 : ref3.startsWith(PAGES_DIR_ALIAS);
            ...
            async function runTurbotrace(staticPages) {
                ...
                if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                    ...
                    let turbotraceFiles;
                    turboTasksForTrace = binding.turbo.createTurboTasks((((ref = config.experimental.turbotrace) == null ? void 0 : ref.memoryLimit) ?? TURBO_TRACE_DEFAULT_MEMORY_LIMIT) * 1024 * 1024);
