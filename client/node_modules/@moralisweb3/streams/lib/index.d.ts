...
import { ApiModule, Core as Core$1 } from '@moralisweb3/common-core';
...
declare class Streams extends ApiModule {
    ...
    static create(core?: Core$1): Streams;
    private constructor();
    setup(): void;
    start(): void;
    ...
    readonly getHistory: (request: _moralisweb3_common_streams_utils.GetHistoryRequest) => Promise<Core.PaginatedResponseAdapter<{
        id: string;
        date: string;
        payload?: (Partial<{
            block: {
    ...
    readonly getLogs: (request: _moralisweb3_common_streams_utils.GetLogsRequest) => Promise<Core.PaginatedResponseAdapter<{
    ...
    readonly retry: (request: _moralisweb3_common_streams_utils.ReplayHistoryRequest) => Promise<Core.ResponseAdapter<{
        id: string;
        date: string;
        payload?: (Partial<{
            block: {
    ...
    readonly getStats: () => Promise<Core.ResponseAdapter<{
    ...
    readonly getStatsById: (request: _moralisweb3_common_streams_utils.GetStatsByIdRequest) => Promise<Core.ResponseAdapter<{
        totalWebhooksDelivered: number;
        totalWebhooksFailed: number;
        totalLogsProcessed: number;
        totalTxsProcessed: number;
    ...
    readonly setSettings: (request: _moralisweb3_common_streams_utils.SetSettingsRequest) => Promise<Core.ResponseAdapter<{
        region?: "us-east-1" | "us-west-2" | "eu-central-1" | "ap-southeast-1" | undefined;
    }, {
        region?: "us-east-1" | "us-west-2" | "eu-central-1" | "ap-southeast-1" | undefined;
    }>>;
    private readonly _readSettings;
    readonly readSettings: () => Promise<Core.ResponseAdapter<{
        region?: "us-east-1" | "us-west-2" | "eu-central-1" | "ap-southeast-1" | undefined;
    }, {
        region?: "us-east-1" | "us-west-2" | "eu-central-1" | "ap-southeast-1" | undefined;
    }>>;
