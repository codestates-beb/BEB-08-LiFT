import { IconHeart, IconHome, IconShoppingCart } from '@tabler/icons-react';
    ...
    <div className='mt-12 mb-12'>
      <div className='w-full flex h-50 items-center'>
        ...
        {session ? (
          ...
          <button
            ...
            className='relative inline-flex items-center justify-center p-0.5 mb-2 mr-4 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800'
          >
            <span className='relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0'>
              Mint DNFT
            </span>
      ...
      {session && (
        <div className='mt-10'>
          ...
          >
            <p className='flex'>
              <p className='font-bold'>안녕하세요. {session?.address} 님</p>
              <button
            ...
            <p className='text-sm mb -inset-5'>
              Native Balance: {nativeBalance?.balance.ether} ETH
            </p>
          </div>
        </div>
      )}
